...
import { hasToken, login, refreshAuthToken } from "../api";
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="max-w-xl text-balance text-4xl font-semibold leading-none tracking-[-0.06em] sm:text-5xl">
                  Pick up your documents right where you left them.
                </h1>
                <p className="max-w-xl text-base leading-7 text-muted-foreground">
                  A softer, cleaner workspace with the same auth flow and the same backend behavior you already have.
                </p>
              </div>
            </div>

            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-border/80 bg-secondary/60 p-4">
                <p className="text-sm font-medium">Access token</p>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">Short-lived authentication for API requests.</p>
              </div>
              <div className="rounded-2xl border border-border/80 bg-secondary/60 p-4">
                <p className="text-sm font-medium">Refresh token</p>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">Seamless session renewal without changing your data flow.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/80 bg-background/95">
          <CardContent className="p-8">
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">Login</p>
              <h2 className="text-2xl font-semibold tracking-[-0.04em]">Sign in</h2>
              <p className="text-sm leading-6 text-muted-foreground">
                Use the same credentials you already register with.
              </p>
            </div>
